...
DROP TABLE IF EXISTS characteristics_prod_avgs;
...
CREATE TABLE meta (
  ...
  1_ratings INT DEFAULT 0,
  2_ratings INT DEFAULT 0,
  3_ratings INT DEFAULT 0,
  4_ratings INT DEFAULT 0,
  5_ratings INT DEFAULT 0,
);
...
CREATE TABLE characteristics_reviews (
  id INT GENERATED BY DEFAULT AS IDENTITY UNIQUE PRIMARY KEY,
  characteristic_id references characteristics(id),
  review_id references reviews(review_id),
  char_value SMALLINT CHECK (rating > 0) (rating < 6) -- range 0 to 5
);
